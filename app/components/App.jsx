...
function Recap({ selected, onBack }) {
  ...
  const items = DATES.filter((d) => selected.includes(d.id) && d.copyLine);
...
export default function App() {
  ...
  return (
    <>
      ...
      {screen === 'catalog' && <Catalog selected={selected} onToggle={toggle} onNext={() => setScreen('recap')} onBack={() => setScreen('intro')} />}
